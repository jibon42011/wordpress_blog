...
add_filter( 'themify_google_fonts', 'themify_theme_portfolio_google_fonts' );
...
function themify_theme_portfolio_custom_script() {
	wp_enqueue_script( 'themify-portfolio-script', THEME_URI . '/skins/portfolio/js/script.js', null, Themify_Enqueue_Assets::$themeVersion, true );	
}
