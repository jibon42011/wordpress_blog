...
if ( ! class_exists( 'TGM_Plugin_Activation',false ) ) {
    ...
    class TGM_Plugin_Activation {
        ...
        protected function do_plugin_install($plugin='',$type='') {
            ...
            if($type==='' && (isset( $_GET['tgmpa-install'] ) || isset( $_GET['tgmpa-update'] ) || isset( $_GET['tgmpa-activate'] ) )){
                $type = isset( $_GET['tgmpa-install'] ) ? $_GET['tgmpa-install'] :
					( isset( $_GET['tgmpa-activate'] ) ? $_GET['tgmpa-activate'] : $_GET['tgmpa-update'] );
            }
