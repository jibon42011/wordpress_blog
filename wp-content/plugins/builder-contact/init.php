...
class Builder_Contact {
    ...
    public static function contact_send() {
		...
		if ( ! empty( $module_settings['upload_dir'] ) && ! str_contains( $module_settings['upload_dir'], '..' ) ) {
			self::$upload_dir = $module_settings['upload_dir'];
        ...
        remove_filter('wp_mail_content_type', array(__CLASS__, 'set_content_type'), 100);
